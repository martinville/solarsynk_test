...
inverter_type_3Phase="$(bashio::config 'inverter_type_3Phase')"
...
echo "3 Phase enabled:" $inverter_type_3Phase
echo ------------------------------------------------------------------------------
...
battery_count=$(jq -r '.data.numberOfBatteries' batterydata.json); if [ $battery_count == "null" ]; then battery_count="0"; fi;
...
#Phase2
grid_power2=$(jq -r '.data.vip[1].power' griddata.json); if [ $grid_power2 == "null" ]; then grid_power2="0"; fi;
grid_voltage2=$(jq -r '.data.vip[1].volt' griddata.json); if [ $grid_voltage2 == "null" ]; then grid_voltage2="0"; fi;
grid_current2=$(jq -r '.data.vip[1].current' griddata.json); if [ $grid_current2 == "null" ]; then grid_current2="0"; fi;
#Phase3
grid_power3=$(jq -r '.data.vip[2].power' griddata.json); if [ $grid_power3 == "null" ]; then grid_power3="0"; fi;
grid_voltage3=$(jq -r '.data.vip[2].volt' griddata.json); if [ $grid_voltage3 == "null" ]; then grid_voltage3="0"; fi;
grid_current3=$(jq -r '.data.vip[2].current' griddata.json); if [ $grid_current3 == "null" ]; then grid_current3="0"; fi;
...
load_current2=$(jq -r '.data.vip[1].current' loaddata.json); if [ $load_current2 == "null" ]; then load_current2="0"; fi;
load_power2=$(jq -r '.data.vip[1].power' loaddata.json); if [ $load_power2 == "null" ]; then load_power2="0"; fi;
load_voltage2=$(jq -r '.data.vip[1].volt' loaddata.json); if [ $load_voltage2 == "null" ]; then load_voltage2="0"; fi;

load_current3=$(jq -r '.data.vip[2].current' loaddata.json); if [ $load_current3 == "null" ]; then load_current3="0"; fi;
load_power3=$(jq -r '.data.vip[2].power' loaddata.json); if [ $load_power3 == "null" ]; then load_power3="0"; fi;
load_voltage3=$(jq -r '.data.vip[2].volt' loaddata.json); if [ $load_voltage3 == "null" ]; then load_voltage3="0"; fi;
...
echo "NumberOfBatteries" $battery_count
...
#Grid 3
echo "grid_power3" $grid_power3
echo "grid_voltage3" $grid_voltage3
echo "grid_current3" $grid_current3
...
echo "load_voltage2" $load_voltage2
echo "load_current2" $load_current2
echo "load_power2" $load_power2

echo "load_voltage3" $load_voltage3
echo "load_current3" $load_current3
echo "load_power3" $load_power3
...
echo "pv3_current" $pv2_current
echo "pv3_power" $pv2_power
echo "pv3_voltage" $pv2_voltage

echo "pv4_current" $pv2_current
echo "pv4_power" $pv2_power
echo "pv4_voltage" $pv2_voltage
...
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "", "friendly_name": "Battery Status"}, "state": "'"$battery1_status"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_battery_status $EntityLogOutput
...
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "number", "state_class":"measurement", "unit_of_measurement": "Count", "friendly_name": "Battery Count"}, "state": "'"$battery_count"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_battery_count $EntityLogOutput
...
#Battery 1
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "voltage", "state_class":"measurement", "unit_of_measurement": "V", "friendly_name": "Battery 1 Voltage"}, "state": "'"$battery1_voltage"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_battery_voltage1 $EntityLogOutput
...
#Battery 2
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "voltage", "state_class":"measurement", "unit_of_measurement": "V", "friendly_name": "Battery 2 Voltage"}, "state": "'"$battery2_voltage"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_battery_voltage2 $EntityLogOutput
...
if [ $inverter_type_3Phase == "true" ]
then
echo "Extending to include 3Phase and extra MPPT parameters and entities."
#3Phase Related Enrtities
#Grid Phase 2
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "power", "state_class":"measurement", "unit_of_measurement": "W", "friendly_name": "Grid Power Phase 2"}, "state": "'"$grid_power2"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_grid_power2 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "voltage", "state_class":"measurement", "unit_of_measurement": "V", "friendly_name": "Grid Voltage Phase 2"}, "state": "'"$grid_voltage2"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_grid_voltage2 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "current", "state_class":"measurement", "unit_of_measurement": "A", "friendly_name": "Grid Current Phase 2"}, "state": "'"$grid_current2"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_grid_current2 $EntityLogOutput
#Grid Phase 3
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "power", "state_class":"measurement", "unit_of_measurement": "W", "friendly_name": "Grid Power Phase 3"}, "state": "'"$grid_power3"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_grid_power3 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "voltage", "state_class":"measurement", "unit_of_measurement": "V", "friendly_name": "Grid Voltage Phase 3"}, "state": "'"$grid_voltage3"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_grid_voltage3 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "current", "state_class":"measurement", "unit_of_measurement": "A", "friendly_name": "Grid Current Phase 3"}, "state": "'"$grid_current3"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_grid_current3 $EntityLogOutput
#Load Pahse 2
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "voltage", "state_class":"measurement", "unit_of_measurement": "V", "friendly_name": "Load Phase 2 Voltage"}, "state": "'"$load_voltage2"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_load_voltage2 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "current", "state_class":"measurement", "unit_of_measurement": "A", "friendly_name": "Load Phase 2 Current"}, "state": "'"$load_current2"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_load_current2 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "power", "state_class":"measurement", "unit_of_measurement": "W", "friendly_name": "Load Phase 2 Power"}, "state": "'"$load_power2"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_load_power2 $EntityLogOutput
#Load Phase 3
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "voltage", "state_class":"measurement", "unit_of_measurement": "V", "friendly_name": "Load Phase 3 Voltage"}, "state": "'"$load_voltage3"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_load_voltage3 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "current", "state_class":"measurement", "unit_of_measurement": "A", "friendly_name": "Load Phase 3 Current"}, "state": "'"$load_current3"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_load_current3 $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "power", "state_class":"measurement", "unit_of_measurement": "W", "friendly_name": "Load Phase 3 Power"}, "state": "'"$load_power3"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_load_power3 $EntityLogOutput
#MPPT3
...
#MPPT4
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "current", "state_class":"measurement", "unit_of_measurement": "A", "friendly_name": "PV4 Current"}, "state": "'"$pv4_current"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_pv4_current $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "power", "state_class":"measurement", "unit_of_measurement": "W", "friendly_name": "PV4 Power"}, "state": "'"$pv4_power"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_pv4_power $EntityLogOutput
curl -s -k -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"device_class": "voltage", "state_class":"measurement", "unit_of_measurement": "V", "friendly_name": "PV4 Voltage"}, "state": "'"$pv4_voltage"'"}' $HTTP_Connect_Type://$Home_Assistant_IP:$Home_Assistant_PORT/api/states/sensor.solarsynk_"$inverter_serial"_pv4_voltage $EntityLogOutput
fi
